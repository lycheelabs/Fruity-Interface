...
namespace LycheeLabs.FruityInterface {
    ...
    public struct DragParams {
        ...
        /// <param name="draggingOver">The target under the mouse cursor (for drop detection).</param>
        ...
        public DragParams(DragTarget target, MouseTarget draggingOver, Vector2 startScreenPos, Vector2 currentScreenPos, MouseButton dragButton) {
            this.target = target;
        ...
        /// <summary>
        /// The target currently under the mouse cursor.
        ...
        /// <summary>True if the mouse is not over the drag target itself.</summary>
